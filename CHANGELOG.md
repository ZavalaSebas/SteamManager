...
- **Game title wraps to two lines**: Changed header to Grid layout so long game names wrap to a second line (`TextWrapping="Wrap"`, `MaxWidth="320"`, `MaxHeight="72"`) instead of being truncated or pushing stats off-screen.
